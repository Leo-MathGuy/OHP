...
import static omega.utils.discordUtils.commandDisabled;
...
public class mapCommands implements MessageCreateListener {
    ...
    private OmegaPlugin mainData;
    private long lastMapChange = 0L;


    public mapCommands(OmegaPlugin _mainData) {
...
//            if (!hasPermission(mapRole, event)) return;
//
...
//            if (!hasPermission(mapConfigRole, event)) return;
